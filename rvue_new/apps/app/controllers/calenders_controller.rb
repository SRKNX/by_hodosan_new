class CalendersController < ApplicationController
  ...
  def index
    ...
    @begin_time   = regulation.begin_time if regulation
    @close_time   = regulation.close_time if regulation
    @interval_s   = regulation.interval_s if regulation
    @interval_e   = regulation.interval_e if regulation
    @unit_minute  = regulation.unit_minute if regulation
  end
